  ...
  return (
    <div className="w-full">
      <div className="w-full flex flex-col rounded-lg border-2  ">
        ...
        <div className="flex flex-row justify-between border-b py-3">
          <p className="px-2 ml-3">
            Thuế <span className="text-[10px] font-light">(12%)</span>
          </p>
          <p className="px-2">{tax}</p>
        </div>
        <div className="flex flex-row justify-between border-b py-3">
          <p className="px-2 ml-3">Các khoản phí khác</p>
          <p className="px-2">{charges}</p>
        </div>
        <div className="flex flex-row justify-between py-3">
          <p className="px-2 ml-3">Tổng giá vé </p>
...
const FlightInfo = () => {
  ...
  const showFlightInfo = flightInfo ? (
    flightInfo.map((value) => (
      ...
      >
        <h3 className="px-2 font-semibold">Thông tin chuyến bay</h3>
    ...
    <p className="text-red-600">Đã xãy ra lỗi!</p>
  );
