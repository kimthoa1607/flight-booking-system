      ...
      <div className='hidden sm:block bg-hero-img bg-cover w-full h-full'>
        <div className='hidden sm:flex flex-col h-full justify-center px-8'>
          ...
          <div className='hidden sm:block text-xl text-slate-100 font-medium mt-6'>
            <p className=''>Ngoài kia là một thế giới rộng lớn, hãy đặt vé máy bay</p>
            <p>một cách dễ dàng và khám phá điểm đến ước mơ của bạn.</p>
          </div>
          <div>
            <button className='text-white text-2xl font-medium mt-6 px-9 rounded-md bg-blue-950 py-2'> <Link to='/flights'>Đặt ngay</Link>
            </button>
          </div>
        </div>
      </div>
